...
export function Nav ({children}:{ children:ReactNode}) {
    return <nav className=" bg-primary text-primary-foreground flex justify-center">
    {children}
    </nav>
}

export function NavItemLinks(props: Omit<ComponentProps<typeof Link>, "classname">) {
